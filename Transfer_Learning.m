...
inputSize = alex.Layers(1).InputSize %Nuevo

layers(23) = fullyConnectedLayer(29);
layers(25) = classificationLayer


%trainingImages.ReadFcn = @readFunctionTrain; %Revisar
...
%testImages.ReadFcn = @readFunctionTrain; %Revisar
...
% 
% picture = imread('C:\Users\sf4e\OneDrive\Kumoh National Institute of Technology\Korea Transport Institute\Accident Videos\TrainingData\Accident\9.bmp');
